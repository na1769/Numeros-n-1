...
function check (){
    ...
    if(get_answer == actual_answer)
    {
        if(answer_turn == "player1")
        {
            ...
            udapte_player1_score = player1_score + 1;
            document.getElementById("player1_score").innerHTML = udapte_player1_score;
        }
        else
        {
            udapte_player2_score = player2_score + 1;
            document.getElementById("player2_score").innerHTML = udapte_player2_score;   
        }
    }
